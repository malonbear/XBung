;(function($, undefined) {
	...
	//显示隐藏对话框
	onShowReveal = function(event) {
		var revealID = event.data.revealID;
		window.xbung.common.fn.showReveal(revealID);
	};
...
;(function($, undefined) {
	//点击增加按钮，弹出对话框
	$('#addProductID').on('touchend', {revealID: 'productInDBTblRevl'}, window.xbung.product.fn.onShowReveal);
